    ...
    <div class="col-md-12 col-12">
        <div class="card">
            ...
            <div class="card-content">
                <div class="card-body">
                    <form class="form form-vertical" action="{{ route('destination.update',$destination->id) }}" method="post"
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="name-vertical" class="form-control" name="name" value="{{$destination->name}}"
                                            placeholder="Name">
                                    </div>
                                    @error('name')
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="type" class="form-control" name="type" value="{{$destination->type}}"
                                            placeholder="type">
                                    </div>
                                    @error('type')
                                        <span class="text-danger" role="alert">*{{ $message }}</span>
