    ...
    <div class="col-md-12 col-12">
        <div class="card">
            ...
            <div class="card-content">
                <div class="card-body">
                    <form class="form form-vertical" action="{{ route('itinerary.update', $itinerary->id) }}" method="post"
                            ...
                            <div class="row">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-select" id="basicSelect" name="package_id">
                                            @foreach ($package as $value)
                                                <option value="{{ $value->id }}" {{ $value->id == $itinerary->package_id ? 'selected' : '' }}>
                                                    {{ $value->name }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                ...
                                <div class="col-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="name-vertical" class="form-control" name="name"
                                            value="{{ $itinerary->name }}" placeholder="Name">
                                    </div>
                                    @error('name')
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <select class="form-select" id="basicSelect" name="status">
                                            <option value="{{ $itinerary->status }}">{{ $itinerary->status }}</option>
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <textarea name="description" id="default" cols="30" rows="10">{{ old('description', strip_tags($itinerary->description) ?? '') }}</textarea>
                                    </div>
                                    @error('description')
                                        <span class="text-danger" role="alert">*{{ $message }}</span>
                                    @enderror
