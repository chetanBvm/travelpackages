    ...
    <div class="col-md-12 col-12">
        <div class="card">
            <div class="card-header">
                ...
                <a href="{{ route('airport.index') }}" type="button" class="btn btn-info gray-btn d-lg-block m-l-15"><i
                        class="bi bi-caret-left-fill"></i><span>Back</span></a>

            </div>
            <div class="card-content">
                <div class="card-body">
                    <form class="form form-vertical" action="{{ route('airport.update', $airport->id) }}" method="post"
                                ...
                                <div class="col-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="name-vertical" class="form-control" name="code"
                                            value="{{ $airport->code }}" placeholder="Enter code">
                                    </div>
                                    @error('code')
                                ...
                                <div class="col-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="name-vertical" class="form-control" name="name"
                                            value="{{ $airport->name }}" placeholder="Enter Name">
                                    </div>
                                    @error('name')
                                        <span class="text-danger" role="alert">*{{ $message }}</span>
                                    @enderror
                                ...
                                <div class="col-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="text-vertical" class="form-control" name="city"
                                            value="{{ $airport->city }}" placeholder="text">
                                    </div>
                                    @error('city')
                                        <span class="text-danger" role="alert">*{{ $message }}</span>
                                    @enderror
                                ...
                                <div class="col-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="text-vertical" class="form-control" name="country_name"
                                            value="{{ $airport->country_name }}" placeholder="text">
                                    </div>
                                    @error('country_name')
                                        <span class="text-danger" role="alert">*{{ $message }}</span>
                                    @enderror
