    ...
    <div class="col-md-12 col-12">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">Edit Stay</h4>
                <a href="{{route('stay.index')}}" type="button"
                class="btn btn-info gray-btn d-lg-block m-l-15"><i class="bi bi-caret-left-fill"></i><span>Back</span></a>

            </div>
            <div class="card-content">
                <div class="card-body">
                    <form class="form form-vertical" action="{{ route('stay.update', $stay->id) }}" method="post"
                            ...
                            <div class="row">
                                ...
                                <div class="col-12">
                                    ...
                                    <div class="form-group preview_holder">
                                        ...
                                        <img id="image" src="<?php echo asset('storage') . '/' . $stay['image']; ?>" class="image_style" alt="your image"
