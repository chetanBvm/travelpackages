    ...
    <div class="col-md-12 col-12">
        ...
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">Create Home Travel Experience</h4>

            </div>
            <div class="card-content">
                <div class="card-body">
                    <form class="form form-vertical" action="{{ route('home-experience.save') }}" method="post"
                                ...
                                <div class="col-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="sub-heading-vertical"
                                            class="form-control @error('subtitle') is-invalid @enderror" name="subtitle" maxlength="60"
